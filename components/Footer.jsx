...
<div>
  ...
  <div className="footer-top">
    <div className="footer-logo">
      <img src="../pics/logo_white.png" alt="Logo"></img>
    </div>
  ...
  <div className="footer-bottom">
    ...
    <p className="copy">Copyright © 2026 <span>PR Pizzerija Roki</span> All Rights Reserved.</p>
    <p className="copy">Website created by: <span><a href="https://www.linkedin.com/in/zsolti-papp-a43b41262/">Papp Zsolt</a></span> </p>
    </div>
  </div>
</footer>
