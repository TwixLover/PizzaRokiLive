    ...
    const checkAuth = async () => {
      try {
        const res = await fetch(
          "https://pizzarokilive.onrender.com/routes/me",
          {
            credentials: "include",
          }
        );
